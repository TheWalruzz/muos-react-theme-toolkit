...
BACKGROUND=${colorVar(styles, "--item-color-active")}
BACKGROUND_ALPHA=0
...
[footer]
FOOTER_HEIGHT=42
FOOTER_BACKGROUND=${colorVar(styles, "--item-color-active")}
...
[header]
HEADER_HEIGHT=42
HEADER_BACKGROUND=${colorVar(styles, "--item-color-active")}
HEADER_BACKGROUND_ALPHA=0
HEADER_TEXT=${colorVar(styles, "--text-color")}
HEADER_TEXT_ALPHA=0

[help]
HELP_BACKGROUND=${colorVar(styles, "--item-color-active")}
...
[charging]
CHARGER_BACKGROUND=${colorVar(styles, "--item-color-active")}
...
[verbose]
VERBOSE_BOOT_BACKGROUND=${colorVar(styles, "--item-color-active")}
...
[keyboard]
OSK_BACKGROUND=${colorVar(styles, "--item-color-active")}
OSK_BACKGROUND_ALPHA=255
OSK_BORDER=${colorVar(styles, "--item-color-active")}
...
[bar]
BAR_BACKGROUND=${colorVar(styles, "--item-color-active")}
...
ROLL_TEXT_ALPHA=255
ROLL_BACKGROUND=${colorVar(styles, "--item-color-active")}
...
COUNTER_BORDER_COLOUR=${colorVar(styles, "--item-color-active")}
