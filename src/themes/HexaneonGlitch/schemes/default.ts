...
HELP_BORDER = ${colorVar(styles, "--item-color-glow")}
...
LIST_FOCUS_BACKGROUND = ${colorVar(styles, "--background-color")}
LIST_FOCUS_BACKGROUND_ALPHA = 200
...
OSK_BORDER = ${colorVar(styles, "--item-color-glow")}
OSK_BORDER_ALPHA = 255
OSK_RADIUS = 3
OSK_TEXT = ${colorVar(styles, "--text-color")}
OSK_TEXT_ALPHA = 225
OSK_TEXT_FOCUS = ${colorVar(styles, "--item-color-active")}
...
MSG_BORDER = ${colorVar(styles, "--item-color-glow")}
...
BAR_BORDER = ${colorVar(styles, "--item-color-glow")}
BAR_BORDER_ALPHA = 255
BAR_RADIUS = 2
BAR_PROGRESS_BACKGROUND = ${colorVar(styles, "--item-color-glow")}
...
ROLL_SELECT_BACKGROUND = ${colorVar(styles, "--item-color-glow")}
ROLL_SELECT_BACKGROUND_ALPHA = 175
ROLL_SELECT_RADIUS = 3
ROLL_BORDER_COLOUR = ${colorVar(styles, "--item-color-glow")}
...
COUNTER_BORDER_COLOUR = ${colorVar(styles, "--item-color-glow")}
